 ...
 * \li  18.08.2009 - (1.0.1) m_CameraInfo must not be initialized after InitCameraList()!
 * \li  02.10.2009 - (1.0.2) with building the cameralist, now now default camera was set
 */
